...
public class FinishTransResponseData {
    private String tid;
    ...
    public FinishTransResponseData(TransactionEntity transactionEntity, List<TransProductResponseData> transProductResponseDataList) {
